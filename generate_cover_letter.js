...
const para3 = "Before becoming a BA, I worked as a software engineer on large projects like the Government Payment Portal and MobilBank. That experience taught me how to build reliable systems, work with large teams, and document processes clearly, skills that I now use every day as a Business Analyst. It also gave me a deep understanding of omnichannel solutions and payment gateways. Together with the teams at Embafinans, we achieved concrete results: the credit scoring system now makes lending decisions 50% faster, the digital sales channel handles 300 to 500 loan applications every day, and the delivery tracking dashboard cut operational mistakes by half.";
...
Packer.toBuffer(doc).then((buffer) => {
  ...
  console.log("V15 cover letter generated!");
});
